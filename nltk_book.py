...
#Deep Learning
#Gradient desent, takes steps proportional to the negative of the gradient at the current point
#Activation function of a node defines the output of that node given an input or set of inputs
#ELU to tune the activation fundtion
#Normalization, introduce some extra complexity
#Gradient Clipping to limit the gradient by the threshold
#Freezing lower layers & Caching the frozen layers & replacing the upper layers
#Regularization: early stopping / l1 & l2 / dropout / max-norm / data augmentation

#Convolution Neutal Network
#Zero padding, for a layer to have the same height and width as the previous layer
#Stride, the distance between two consecutive receptive fields
#Great Intro:
#https://adeshpande3.github.io/adeshpande3.github.io/A-Beginner's-Guide-To-Understanding-Convolutional-Neural-Networks/

#Recurrent Neutal Network
#page 385, 4 basic RNN architecture

BPTT， embedding (NLP), sample softmax,

#good parameter initialization, non-saturating activation functions, batch normalization, gradient clipping and faster optimizes

long training time, truncated backpropagation

long-term memory,

#LSTM cell can learn to recognize an important input, store it in the long-term state, preserve it or extract it
#Peephole connections, give gate controllers more context
#GTU cell, a simpler version of LSTM cell
